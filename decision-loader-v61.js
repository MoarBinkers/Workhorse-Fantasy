// v61.6 — keep startup lean. Enforce caps and repair Sleeper Rank/EDGE first; optional polish/news loads later or on demand.
(()=>{
  const coreFiles=[
  ...
  loadOne('./rank-edge-fix-v95.js?v=952');
