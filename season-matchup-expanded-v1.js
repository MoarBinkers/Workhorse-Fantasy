...
.wh-player-body>.wh-2025-ref::before{content:"MATCHUP BREAKDOWN";display:block;margin-bottom:13px;font-size:9px;line-height:1;font-weight:1000;letter-spacing:.16em;color:#7f9dad}
...
.wh-player-body .wh-ref-head small{font-size:10px!important;color:#91a8b6!important;letter-spacing:.12em!important}
...
.wh-player-body>.wh-2025-ref + .wh-matchup-hero{margin-top:0!important;opacity:.88}
.wh-player-body>.wh-2025-ref + .wh-matchup-hero::before{content:"2026 LIVE SAMPLE";position:absolute;transform:translateY(-20px);font-size:7px;font-weight:950;letter-spacing:.12em;color:#627c8b}
...
function prioritizeReference(){
 ...
 if(body&&ref&&body.firstElementChild!==ref)body.prepend(ref);
}
