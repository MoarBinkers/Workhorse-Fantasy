(async()=>{
'use strict';
const fail=e=>{const m=String(e&&e.message?e.message:e).replace(/[&<>]/g,s=>({'&':'&amp;','<':'&lt;','>':'&gt;'}[s]));document.body.innerHTML='<div class="wh-rank-load"><div><b>SANDBOX · NOT LIVE</b><h1>WORKHORSE</h1><p>The rankings workspace could not start.</p><pre>'+m+'</pre><a href="./sandbox.html">← Season Home</a></div></div>'};
try{
 document.body.innerHTML='<div class="wh-rank-load"><div><b>SANDBOX · NOT LIVE</b><h1>WORKHORSE</h1><p>Loading Rankings & Draft Tools…</p></div></div>';
