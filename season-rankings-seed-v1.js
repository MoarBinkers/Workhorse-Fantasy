...
function loadRosTiers(){if(isWeekly||window.__WH_ROS_TIERS_V3__)return;add('./season-ros-tiers-v3.js?v=3','data-wh-ros-tiers-v3')}
function loadRosChangeFix(){if(isWeekly||window.__WH_ROS_CHANGE_FIX_V1__)return;add('./season-ros-change-fix-v1.js?v=1','data-wh-ros-change-fix')}
function seed(){
