...
function loadDecision(){const command=()=>{if(!window.__WH_COMMAND_CENTER_V1__)add('./season-command-center-v1.js?v=1','data-wh-command-center')};if(window.WorkhorseDecisionEngine){command();return}add('./workhorse-decision-engine-v1.js?v=5','data-wh-decision-engine',command)}
function seed(){
